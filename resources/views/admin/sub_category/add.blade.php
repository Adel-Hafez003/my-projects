                        ...
                        <form action="" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required value="{{ old('name') }}" name="name" placeholder="Sub_Category Name">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="meta_title" placeholder="Meta title" value="{{ old('meta_title') }}">
                            </div>
