                        ...
                        <div class="form-tab">
                            ...
                            <div class="tab-content" id="tab-content-5">
                                ...
                                <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                    <form id="SubmitFormRegister" method="POST" action="{{ url('auth_register') }}">
                                        {{ csrf_field() }}
                                        <div class="form-group">
...
{{--    <div class="container newsletter-popup-container mfp-hide" id="newsletter-popup-form">
    ...
    <script type="text/javascript">
        ...
        $(document).delegate('#SubmitFormLogin', 'submit', function(e) {
            e.preventDefault();
            $.ajax({
                type: "POST",
                url: "{{ url('auth_login') }}",
                ...
                success: function(data) {
                    ...
                    if (data.status === true) {
                        ...
                        // يمكنك إضافة أي إجراءات أخرى هنا إذا لم يكن تسجيل الدخول ناجحًا
                    }
                },
                error: function(data) {
